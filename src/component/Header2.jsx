        ...
        <>
            <div className='px-[50px] lg:px-[60px] h-[80px] items-center justify-between flex shadow-gray-200 shadow-lg sticky top-0 bg-white z-50 w-fixed '>
                <div className="flex overflow-x-scroll no-scrollbar">
                    <div className='flex'>
                        <button className="border border-gray-200 rounded-[20px] h-[35px] w-fit mx-1 my-2 truncate px-1 cursor-pointer">
                    ...
                    <div className='flex'>
                        ...
                        <button className="border border-gray-200 rounded-[20px] h-[35px] w-fit mx-1 my-2 truncate px-1cursor-pointer">
